<template>
  <div class="calendarList" id="calendarDemo">
    ...
    <full-calendar :events="events" locale="fr" lang="zh" firstDay='0' weekMode="liquid" ref="calendar" @changeMonth="changeMonth"
...
<script>
  ...
  import {
    festival
  } from '../../assets/calendar/festival.js';
  import {
    calendar
  } from '../../assets/calendar/calendar.js';
